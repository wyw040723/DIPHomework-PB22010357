...
def parse_args():
    ...
    p.add_argument('--maximum_pts_num', type=int, default=3000,
                   help='Maximum number of 3D points to use (must match training)')
...
def main():
    ...
    print(f'Loaded COLMAP dataset with {len(dataset.points3D_xyz)} points and {len(dataset)} views')
    sample = dataset[0]
